# MCS - VF
The Virtual Friend made by team MCS for the Ignite competition. You can visit this on [https://mcs-vf.herokuapp.com](https://mcs-vf.herokuapp.com)
...
When we wish to implement dynamic content in the response, we make the dialogflow agent respond with a special command whose syntax is like: `cmd:`